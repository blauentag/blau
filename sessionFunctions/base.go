...
import (
	...
	"github.com/blauentag/blau/scheduleEngine"
	"github.com/blauentag/blau/settings"
	"github.com/blauentag/blau/viewModel/socketViews"
...
func WriteLog(uniqueId string, message string) (err error) {
	...
	log := "src/github.com/blauentag/blau/log/plugins/" + uniqueId + ".log"
	if uniqueId == "" {
		log = "src/github.com/blauentag/blau/log/app.log"
	}
